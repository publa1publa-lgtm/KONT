...
export function GoogleSheetsLogo({ className, title = "Google Sheets" }: Props) {
  return (
    <Svg className={className} title={title}>
      <path fill="#0F9D58" d="M14.727 6.727H14V0H4.91A1.91 1.91 0 0 0 3 1.91v20.18A1.91 1.91 0 0 0 4.91 24h14.18A1.91 1.91 0 0 0 21 22.09V6.727h-6.273z"/>
      <path fill="#004D40" d="M16 14.5H8v5h8v-5zm-4.5 4H9v-1.25h2.5v1.25zm0-2H9v-1.25h2.5V16.5zm3.5 2h-2.5v-1.25H15v1.25zm0-2h-2.5V16.5H15v1.25z"/>
      <path fill="#87CEAC" d="M14.727 0v5.818a.91.91 0 0 0 .91.91H21L14.727 0z"/>
    </Svg>
  );
}

export function GoogleCalendarLogo({ className, title = "Google Calendar" }: Props) {
  return (
    <Svg className={className} title={title}>
      <path fill="#4285F4" d="M18.316 5.684H5.684v12.632h12.632V5.684z"/>
      <path fill="#fff" d="M15.5 9.5h-1.25v1.25H15.5V9.5zm0 2.5h-1.25v1.25H15.5V12zm-2.5 0h-1.25v1.25H13V12zm-2.5 0H9.25v1.25H10.5V12zm5-5h-1.25v1.25H15.5V7zm-2.5 0h-1.25v1.25H13V7zm-2.5 0H9.25v1.25H10.5V7zm5 5h-1.25v1.25H15.5V12z"/>
      <path fill="#1A73E8" d="M19.263 3.789H4.737A.94.94 0 0 0 3.79 4.737v14.526c0 .524.421.948.948.948h14.526a.948.948 0 0 0 .948-.948V4.737a.948.948 0 0 0-.948-.948zM18.316 18.316H5.684V7.58h12.632v10.737z"/>
    </Svg>
  );
}

export function GoogleLogo({ className, title = "Google" }: Props) {
  return (
    <Svg className={className} title={title}>
...
export function MetaLogo({ className, title = "Meta" }: Props) {
  return (
    // Contour infinity in a square-friendly viewBox.
    // It avoids the "cropped wide wordmark" look and scales cleanly inside the platform tiles.
